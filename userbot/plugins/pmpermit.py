...
async def do_pm_permit_action(event, chat):  # sourcery no-metrics
    ...
    if custompmpermit is not None:
        ...
        USER_BOT_NO_WARN = f"""𓆩 𝑷𝑴 𝑺𝑬𝑪𝑼𝑹𝑰𝑻𝒀 𓆪
・منـور حبـي {mention} ❤️.
ꔹ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ꔹ
ᯎ انـي حـاليا غـير متـواجد ❤️.
ᯎ يمـكن اكـون نـايم او مشـغول ❤️.
ᯎ دز رسـالتك و اصـبر بس اخلـص ارد عليك ❤️.
ᯎ لا ترسـل كثـير مـابغـا تنـحظر و شكـرا ❤️.
ꔹ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ꔹ
・اخـتر احـدى الاختيـارات و اصـبر ❤️ .
・عـندك 𓆩 {warns}/{totalwarns} 𓆪 تحـذيرات ❤️,
...
مالك الحساب مشغول الان  عندما يصبح مالك الحساب متصلا سوف يقوم بالرد عليك \
