...
@catub.cat_cmd(
    ...
    info={
        ...
        "examples": "{tr}المشرفين @catuserbot_support",
    },
)
async def _(event):
...
@catub.cat_cmd(
    ...
    info={
        ...
        "examples": "{tr}البوتات @catuserbot_support",
    },
)
async def _(event):
...
@catub.cat_cmd(
    ...
    info={
        ...
        "usage": [
            "{tr}المعلومـات <إسم المستخـدم/معرّف المستخـدم>",
            "{tr}المعلومـات <في المجموعـة التي تريدهـا>",
        ],
        "examples": "{tr}معلومات @catuserbot_support",
    },
)
